...
{
    public enum ObjectType { SmallGem, BigGem, Enemy, SpeedItem}

    public Tilemap tilemap;
    public GameObject[] objectPrefabs;
    public float speedItemProbability = 0.1f;
    ...
    private ObjectType RandomObjectType()
    {
        ...
        else if(randomChoice <= (enemyProbability + bigGemProbability + speedItemProbability))
        {
    ...
    private void SpawnObject()
    {
        ...
        if (validPositionFound)
        {
            ...
            if (objectType == ObjectType.Enemy)
            {
                ...
                if (enemy != null)
                {
                    enemy.ScaleStats(GameController.currentLevelIndex); // Scale enemy stats
                }
            }
